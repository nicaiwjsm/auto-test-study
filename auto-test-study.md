...
1. 掌握 Python + Requests 实现基础接口请求
2. 完成商城项目登录 POST 接口调用实战
3. 熟悉接口响应结果断言写法，校验返回字段
4. 学习 jsonpath 语法，精准提取接口 token 鉴权参数
5. 实现**登录鉴权 -> 携带 Token 调用业务接口**完整流程
...
1. 学习接口测试用例规范化编写
2. 掌握接口请求参数封装与数据驱动
3. 深入学习多接口串联实战、异常场景测试
4. 逐步接入 Pytest 测试框架统一管理用例
